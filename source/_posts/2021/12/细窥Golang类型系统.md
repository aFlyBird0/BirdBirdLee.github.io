...
4. **类型兼容**——
   ...
   2. 如何定义两个类型是否相等？——在[Go的可赋值判断]([The Go Programming Language Specification - go.dev](https://go.dev/ref/spec#Assignability))中主要由类型是否可以互换引用决定。我们等会会详细探讨。
