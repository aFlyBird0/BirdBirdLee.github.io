...
![image-20211103112808000](C:\Users\LHP\AppData\Roaming\Typora\typora-user-images\image-20211103112808000.png)
...
![image-20211103145740364](https://bird-notes.oss-cn-hangzhou.aliyuncs.com/img/image-20211103145740364.png)

![image-20211103145835752](https://bird-notes.oss-cn-hangzhou.aliyuncs.com/img/image-20211103145835752.png)

### 9.1 简单总结一下

别的不说，光凭两张图就能截下完整代码这一点，就够诱人了。
...
**现在只要改一下常量，把要支持的天数常量加到数组里就好**。除非要改内部实现，否则完全不用改动其他地方的代码。



（其实还是能优化的，比如把数组的定义，放在靠近循环的位置）
